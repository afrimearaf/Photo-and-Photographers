            ...
            <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand mr-3" href="index.php">Dashboard</a><i class='fa fa-chevron-right text-secondary'> </i> <a class="navbar-brand ml-3"  href="photos.php">Photos</a>
                    </div>
                           ...
                           <?php bulk_photos(); ?>
                            ...
                            <form action="" method="post">
                                <div class="card-header">
                                    <h4 class="card-title"> View All Photos</h4>
                                    <div class="col-lg-6 ">
